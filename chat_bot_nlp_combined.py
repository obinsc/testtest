...
sent=list()
#ifile  = open('/opt/bitnami/pyfiles/ques.csv', "r")
ifile  = open('F:/chatbotworkspace/facebookJavabot/ques.csv', "r")
...
#input_str= "I have arrears on my account. Can I make PPI claim?"
